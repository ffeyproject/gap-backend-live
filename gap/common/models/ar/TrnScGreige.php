...
{
    //CONSTANTS--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------CONSTANTS
    const PROCESS_DYEING = 1;const PROCESS_PRINTING = 2;const PROCESS_PFP = 3;
    /**
     * @return array
     */
    ...
    const LEBAR_KAIN_44 = 1;const LEBAR_KAIN_58 = 2;const LEBAR_KAIN_64 = 3;
    /**
     * @return array
     */
    ...
    public function rules()
    {
        return [
            ...
            ['lebar_kain', 'in', 'range' => [TrnScGreige::LEBAR_KAIN_44, TrnScGreige::LEBAR_KAIN_58, TrnScGreige::LEBAR_KAIN_64]],
