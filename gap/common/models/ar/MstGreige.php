...
class MstGreige extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['gap', 'stock', 'available', 'booked_wo', 'stock_pfp', 'stock_wip', 'stock_ef', 'booked', 'booked_pfp', 'booked_wip', 'booked_ef'], 'number'],
            [['gap', 'stock', 'available', 'booked_wo', 'stock_pfp', 'stock_wip', 'stock_ef', 'booked', 'booked_pfp', 'booked_wip', 'booked_ef'], 'default', 'value' => 0],
            [['aktif'], 'boolean'],
