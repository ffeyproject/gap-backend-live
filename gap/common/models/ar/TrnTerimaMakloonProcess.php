...
/**
 * This is the model class for table "trn_terima_makloon_process".
 *
 * @property int $id
 ...
 * @property TrnWo $wo
 * @property TrnTerimaMakloonProcessItem[] $trnTerimaMakloonProcessItems
 */
class TrnTerimaMakloonProcess extends \yii\db\ActiveRecord
{
    ...
    {
        return 'trn_terima_makloon_process';
    }
    ...
    {
        return [
            [['jenis_gudang', 'sc_id', 'sc_greige_id', 'mo_id', 'wo_id', 'vendor_id', 'no_urut', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'default', 'value' => null],
            [['jenis_gudang', 'sc_id', 'sc_greige_id', 'mo_id', 'wo_id', 'vendor_id', 'no_urut', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'integer'],

            [['jenis_gudang', 'wo_id', 'date', 'wo_color_id'], 'required'],
    ...
    /**
     * Gets query for [[TrnTerimaMakloonProcessItems]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getTrnTerimaMakloonProcessItems()
    {
        return $this->hasMany(TrnTerimaMakloonProcessItem::className(), ['terima_makloon_id' => 'id']);
    }
