...
{
    const STATUS_DRAFT = 1;const STATUS_POSTED = 2; const STATUS_APPROVED = 3; const STATUS_PROCESSED = 4;
    /**
     * @return array
     */
    ...
    public function rules()
    {
        return [
            ...
            [['greige_group_id', 'greige_id', 'no_urut', 'created_at', 'created_by', 'updated_at', 'updated_by', 'handling_id', 'approved_by', 'approved_at', 'proses_sampai'], 'integer'],
            [['qty'], 'number'],
