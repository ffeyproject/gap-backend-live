...
/**
 * MstCustomerSearch represents the model behind the search form of `common\models\ar\MstCustomer`.
 */
class MstCustomerSearch extends MstCustomer
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['cust_no', 'telp', 'fax', 'email', 'address', 'cp_name', 'cp_phone', 'cp_email', 'npwp', 'name'], 'safe'],
            [['aktif'], 'boolean'],
        ];
    }
