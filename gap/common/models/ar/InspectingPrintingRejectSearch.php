...
/**
 * InspectingPrintingRejectSearch represents the model behind the search form of `common\models\ar\InspectingPrintingReject`.
 */
class InspectingPrintingRejectSearch extends InspectingPrintingReject
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = InspectingPrintingReject::find();
