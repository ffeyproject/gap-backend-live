    ...
    echo $form->field($model, 'stock_id')->widget(Select2::classname(), [
        ...
        'pluginOptions' => [
            ...
            'ajax' => [
                ...
                'dataType' => 'json',
                'data' => new JsExpression('function(params) { return {processId:'.TrnScGreige::PROCESS_PFP.', kartuProsesId:'.$model->kartu_process_id.', greigeId:'.$model->orderPfp->greige_id.', asalGreige:'.$model->kartuProcess->asal_greige.', jenisGudang:'.TrnStockGreige::JG_FRESH.', q:params.term}; }'),
                //'delay' => 250,
