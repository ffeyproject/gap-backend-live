...
$('#InspectingItemTable tbody').on( 'click', 'button.editItemData', function () {
    ...
    $.confirm({
        ...
        content: '' +
            ...
            '<div class="form-group"><label>Ukuran</label><input type="text" class="editUkuran form-control" value="' + data.ukuran +'"/></div>' +
        ...
        buttons: {
            formSubmit: {
                ...
                action: function () {
                    ...
                    itemTable.row(rowNumber).data({grade: grade, gradeLabel: gradeLabel, ukuran: ukuran, join_piece: joinPiece, keterangan: keterangan}).draw(false);
                }
            },
            cancel: function () {
                //close
