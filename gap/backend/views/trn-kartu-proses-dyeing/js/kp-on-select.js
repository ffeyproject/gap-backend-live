$('#trnkartuprosesdyeing-wo_id').val(null);
$('#trnkartuprosesdyeing-wo_id').empty();
...
/*function kpOnSelect(e) {
    $('#trnkartuprosesdyeing-wo_id').val(null).trigger('change');

    let params = e.params; //console.log(e.params);
