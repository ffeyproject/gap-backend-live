        ...
        <div class="col-md-4">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php
                    /*echo $form->field($model, 'bank_acct_id')->widget(Select2::class, [
                        'options' => ['placeholder' => 'Pilih ...'],
                        'pluginOptions' => [
                            'allowClear' => true,
                        ],
                        'data' => MstBankAccount::optionList(),
                    ]);*/
                    ?>
                </div>
            </div>
            ...
            <div class="box">
                <div class="box-body">
                    ...
                    <?=$form->field($model, 'marketing_id')->widget(Select2::class, [
                        ...
                        'data' => User::getUsersByRoles(Yii::$app->params['rbac_roles']['marketing']),
                    ])?>
...
<?php
$this->registerJs($this->render('js/form_local.js'), View::POS_END);
