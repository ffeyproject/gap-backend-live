...
$moForm.on('afterInit', function (e) {
    ...
    $("#CheckBtMoReWo").click(function (e) {
        ...
        if (!noWo) {
            $moForm.yiiActiveForm('updateAttribute', 'trnmoprintingform-re_wo', ["Nomor WO tidak boleh kosong."]);
        }else {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#trnmoprintingform-selvedge_continues").val(data["selvedge_continues"]);
                    $("#trnmoprintingform-selvedge_stamping").val(data["selvedge_stamping"]);
                    $("#trnmoprintingform-shipping_method").val(data["shipping_method"]);
                    $("#trnmoprintingform-shipping_sorting").val(data["shipping_sorting"]);
