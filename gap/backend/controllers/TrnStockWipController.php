 ...
 */
class TrnStockWipController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $info = 'Stock greige gagal proses yang masih bisa digunakan kembali.';
        Yii::$app->session->setFlash('info', $info);
        $searchModel = new TrnStockGreigeSearch(['jenis_gudang'=>TrnStockGreige::JG_WIP]);
