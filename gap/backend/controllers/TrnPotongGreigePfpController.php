 ...
 */
class TrnPotongGreigePfpController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider->query->andWhere(['trn_stock_greige.jenis_gudang' => TrnStockGreige::JG_PFP]);
    ...
    public function actionPosting($id)
    {
        ...
        try {
            ...
            foreach ($model->trnPotongGreigeItems as $trnPotongGreigeItem) {
                ...
                $modelNewStock->note = 'Pemotongan ID: '.$model->id.', ItemID: '.$trnPotongGreigeItem->id;
            ...
            //tambahan 1 roll lagi yang merupakan sisa pemotongan
            $modelNewStock = new TrnStockGreige();
            $modelNewStock->load([$modelNewStock->formName()=>$stockGreige->attributes]);
            $modelNewStock->panjang_m = $stockGreige->panjang_m - $itemsTotal;
