...
/**
 * This is the model class for table "trn_kartu_proses_printing_item".
 *
 * @property int $id
 * @property int $sc_id
...
class TrnKartuProsesPrintingItem extends \yii\db\ActiveRecord
{
    ...
    {
        return 'trn_kartu_proses_printing_item';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['sc_id', 'sc_greige_id', 'mo_id', 'wo_id', 'kartu_process_id', 'stock_id', 'panjang_m', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'default', 'value' => null],
