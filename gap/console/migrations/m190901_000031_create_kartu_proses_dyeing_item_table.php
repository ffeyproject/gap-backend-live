 ...
 */
class m190901_000031_create_kartu_proses_dyeing_item_table extends Migration
{
    const TABLE_NAME = "trn_kartu_proses_dyeing_item";
    ...
    public function up()
    {
        ...
        $this->addForeignKey('fk_'.self::TABLE_NAME.'_kartu_proses', self::TABLE_NAME, 'kartu_process_id', 'trn_kartu_proses_dyeing', 'id');
