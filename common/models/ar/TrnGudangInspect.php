...
/**
 * This is the model class for table "trn_gudang_inspect".
 *
 * @property int $id
 ...
 *
 * @property TrnGudangInspectItem[] $trnGudangInspectItems
 * @property MstGreige $greige
 * @property MstGreigeGroup $greigeGroup
 */
class TrnGudangInspect extends ActiveRecord
{   
    ...
    public static function statusOptions(){
        return [self::STATUS_DRAFT => 'Draft', self::STATUS_POSTED => 'Posted', self::STATUS_OUT => 'All Out'];
    }
    ...
    public function getTrnGudangInspectItems()
    {
        return $this->hasMany(TrnGudangInspectItem::class, ['trn_gudang_inspect_id' => 'id']);
    }

    public function getTrnGudangInspectItemsNotOut()
    {
        return $this->hasMany(TrnGudangInspectItem::class, ['trn_gudang_inspect_id' => 'id'])->where(['is_out' => false]);
    }
