...
class TrnStockGreige extends \yii\db\ActiveRecord
{
    ...
    const JG_FRESH = 1;const JG_WIP = 2;const JG_PFP = 3; const JG_EX_FINISH = 4; const JG_PFP_PERSIAPAN = 5; const JG_MUTASI_GD_JADI = 6;
    /**
     * @return array
     */
    public static function jenisGudangOptions(){
        return [self::JG_FRESH => 'Fresh', self::JG_WIP => 'WIP', self::JG_PFP => 'PFP', self::JG_EX_FINISH => 'EX Finish', self::JG_PFP_PERSIAPAN => 'Gudang Persiapan PFP', self::JG_MUTASI_GD_JADI => 'Gudang Mutasi'];
    }
    ...
    public function rules()
    {
        return [
            ...
            ['jenis_gudang', 'in', 'range' => [self::JG_FRESH, self::JG_WIP, self::JG_PFP, self::JG_EX_FINISH, self::JG_PFP_PERSIAPAN, self::JG_MUTASI_GD_JADI]],
