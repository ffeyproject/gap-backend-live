...
/**
 * This is the model class for table "trn_kirim_makloon".
 *
 * @property int $id
 ...
 * @property TrnWo $wo
 * @property TrnKirimMakloonItem[] $trnKirimMakloonItems
 */
class TrnKirimMakloon extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(TrnKirimMakloonItem::className(), ['kirim_makloon_id' => 'id']);
    }
