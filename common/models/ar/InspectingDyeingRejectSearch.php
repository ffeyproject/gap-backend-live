...
/**
 * InspectingDyeingRejectSearch represents the model behind the search form of `common\models\ar\InspectingDyeingReject`.
 */
class InspectingDyeingRejectSearch extends InspectingDyeingReject
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = InspectingDyeingReject::find();
