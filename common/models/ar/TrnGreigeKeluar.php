...
class TrnGreigeKeluar extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['no_urut', 'posted_at', 'approved_at', 'approved_by', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by','wo_id'], 'default', 'value' => null],
            [['no_urut', 'posted_at', 'approved_at', 'approved_by', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by','wo_id'], 'integer'],
            [['date', 'jenis'], 'required'],
