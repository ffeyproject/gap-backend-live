...
/**
 * MstGreigeGroupSearch represents the model behind the search form of `common\models\ar\MstGreigeGroup`.
 */
class MstGreigeGroupSearch extends MstGreigeGroup
{
    ...
    {
        return [
            [['id', 'jenis_kain', 'lebar_kain', 'unit', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'integer'],
