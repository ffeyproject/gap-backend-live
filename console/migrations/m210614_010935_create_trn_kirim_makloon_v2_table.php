...
/**
 * Handles the creation of table `{{%trn_kirim_makloon_v2}}`.
 */
class m210614_010935_create_trn_kirim_makloon_v2_table extends Migration
{
    const TABLE_NAME = "trn_kirim_makloon_v2";
