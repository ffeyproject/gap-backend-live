...
<div class="trn-kartu-proses-celup-form">
            ...
            <div class="box">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <?php
                            $ajaxUrl = Url::to(['ajax/lookup-order-celup']);
                            $orderCelup = empty($model->order_celup_id) ? '' : $model->orderCelup->no;
                            echo $form->field($model, 'order_celup_id')->widget(Select2::class, [
                                'initValueText' => $orderCelup, // set the initial display text
