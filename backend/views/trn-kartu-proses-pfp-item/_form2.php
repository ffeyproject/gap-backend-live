...
<div class="kartu-proses-pfp-item-form">
    <?php $form = ActiveForm::begin([
        ...
        'action' => ['trn-kartu-proses-pfp-item/add-create', 'processId' => $model->kartu_process_id],
        'method' => 'post',
    ]); ?>
    ...
    <?= Html::textarea('alasan', '', [
        ...
        'class' => 'form-control',
        'rows' => 3,
        'placeholder' => 'Tuliskan alasan penambahan roll (misalnya: tambahan batch karena roll sebelumnya cacat)',
        'required' => true,
    ]) ?>
...
<?php
$js = <<<JS
$(document).off('click', '.pilih-stock').on('click', '.pilih-stock', function(e) {
    e.preventDefault();
...
$('#KartuProsesItemForm').off('submit').on('submit', function(e) {
