...
$this->title = 'Buat Kartu Stock Mutasi Printing';
$this->params['breadcrumbs'][] = ['label' => 'Pembuatan Kartu Stock Mutasi', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="trn-kartu-proses-mutasi-create-printing">
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">Form Kartu Stock Mutasi Printing</h3>
        </div>
        <div class="box-body">
                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'wo_id')->widget(Select2::class, [
                        ...
                        'pluginOptions' => [
                            ...
                            'ajax' => [
                                'url' => Url::to(['/ajax/lookup-wo-printing']),
                                'dataType' => 'json',
                    ...
                    <?= $form->field($model, 'jenis_printing')->widget(Select2::classname(), [
                        'data' => \common\models\ar\TrnKartuProsesPrinting::jenisPrintingOptions(),
                        'options' => ['placeholder' => 'Pilih Jenis Printing...'],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],
                    ]) ?>
