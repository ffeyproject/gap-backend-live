...
<div class="trn-buy-pfp-form">
            ...
            <div class="box">
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"><?= $form->field($model, 'no_referensi')->textInput(['maxlength' => true]) ?></div>
                    </div>

                    <div class="row">
                        <div class="col-md-6"><?= $form->field($model, 'vendor')->textInput(['maxlength' => true]) ?></div>
    ...
    <?php //echo $form->field($model, 'greige_group_id')->textInput(); ?>
    ...
    <?php //echo $form->field($model, 'approval_id')->textInput(['maxlength' => true]); ?>

    <?php //echo $form->field($model, 'approval_time')->textInput(); ?>

    <?php //echo $form->field($model, 'reject_note')->textarea(['rows' => 6]); ?>
