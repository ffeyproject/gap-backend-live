                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            [
                                'label'=> 'Laporan Rekap Mesin',
                                'icon' => 'circle-o',
                                'url' => ['/processing-dyeing/laporan-rekap-mesin'],
                            ...
                            [
                                ...
                                'active' => $moduleId=='app-backend' && $controllerId == 'laporan' && $actionId=='rekap-bulanan-processing'
                            ],
                            [
                                'label'=>'Qo',
                                'icon' => 'circle-o',
                                'url' => ['/processing-rekap-qo/index'],
                                'active' => $moduleId=='app-backend' && $controllerId == 'processing-rekap-qo'
                            ],
                        ]
                    ],
                    [
