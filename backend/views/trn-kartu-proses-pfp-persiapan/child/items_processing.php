                ...
                <?=GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'content' => function($data){
                                return Html::a(
                                    ...
                                    ['/trn-kartu-proses-pfp-item/edit-qty', 'id' => $data->id],
                                    [
                                        'data-toggle' => "modal",
                                        'data-target' => "#kartuProsesPfpModal",
                        ...
                        [
                            ...
                            'content' => function($data){
                                return Html::a(
                                    $data->mesin ?: '(belum diisi)',
                                    ['/trn-kartu-proses-pfp-item/edit-mesin', 'id' => $data->id],
                                    [
                                        'data-toggle' => "modal",
                                        'data-target' => "#kartuProsesPfpModal",
                                        'data-title' => 'Edit Mesin Roll ID: '.$data->id. '(' .$data->panjang_m . ' )',
