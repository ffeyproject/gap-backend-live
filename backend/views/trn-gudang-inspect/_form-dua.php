            ...
            <div class="box">
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?= $form->field($model, 'jenis_beli')->radioList(TrnGudangInspect::jenisBeliOptions()) ?>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php
                            $asalGreiges = [
                                TrnGudangInspect::ASAL_GREIGE_WJL => TrnGudangInspect::asalGreigeOptions()[TrnGudangInspect::ASAL_GREIGE_WJL],
                                TrnGudangInspect::ASAL_GREIGE_RAPIER => TrnGudangInspect::asalGreigeOptions()[TrnGudangInspect::ASAL_GREIGE_RAPIER]
