    ...
    if(keys.length > 0){
        if(greigeId && greigeGrade){
                ...
                buttons: {
                    ya: function () {
                        $.ajax({
                            ...
                            data:{formData:{keys:keys, greigeId:greigeId, greigeGrade: greigeGrade}},
                            url: actionUrl,
            ...
            $.alert({
                icon: 'fa fa-warning',
                title: 'Peringatan..!',
                content: 'Greige yang akan dijadikan hasil mix belum dipilih, atau Anda belum menentukan grade nya.',
                type: 'red',
                typeAnimated: true,
            });
        }
