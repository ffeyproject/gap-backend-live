...
$('#InspectingItemTable tbody').on( 'click', 'button.editItemData', function () {
    ...
    $.confirm({
        ...
        content: '' +
            ...
            '<div class="form-group"><label>Grade</label><select id="optionGrade" class="editGrade form-control"><option value="7">Grade A+</option> <option value="8">Grade A*</option> <option value="3">Grade C</option> <option value="4">Piece Kecil</option> <option value="5">Sample</option> <option value="1">Grade A</option> <option value="2">Grade B</option></select></div>' +
...
$('#InspectingFormHeader').on('afterInit', function (e) {
    ...
    $('#InspectingFormHeader').on('beforeSubmit', function () {
        ...
        if(dataItems.length < 1){
            ...
            formData.push({name: 'items', value: JSON.stringify(dataItems)}, {name: 'deletedItems', value: JSON.stringify(deletedItems)});
...
$('#InspectingFormItem').on('afterInit', function (e) {
    $('#InspectingFormItem').on('beforeSubmit', function () {
        let data = {
            ...
            ukuran: $('#InspectingFormItem').yiiActiveForm('find', 'inspectingitemsform-ukuran').value,
            join_piece: $('#InspectingFormItem').yiiActiveForm('find', 'inspectingitemsform-join_piece').value,
            keterangan: $('#InspectingFormItem').yiiActiveForm('find', 'inspectingitemsform-keterangan').value,
            qr_code: 0,
        };
