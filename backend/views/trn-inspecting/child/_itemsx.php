            ...
            <?php foreach ($model->getInspectingItems()->orderBy('id ASC')->all() as $index=>$item):?>
                ...
                <tr>
                    ...
                    <td style="width: 100px;">
                        <?php 
                            $printed = $item['qr_print_at'] ? 'btn btn-success center-block' : 'btn btn-default center-block';
                            if ($item['is_head'] == 1) {
                                echo ' '.Html::a('PRINT '.'<span><i class="fa fa-qrcode"></i></span>', ['qr', 'id' => $item['id']], ['class' => $printed]);
                            }
                        ?>
                    </td>
    ...
    <div class="col-md-6">
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <?= Html::a('PRINT '.'<span><i class="fa fa-qrcode"></i></span>', ['qr-all', 'id' => $model->id], ['class' => 'btn btn-default']); ?>
                </div>
            </div>
            <div class="box-body">
                <table class="table table-bordered table-striped">
