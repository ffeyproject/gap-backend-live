...
/* @var $searchModel common\models\ar\TrnKirimMakloonSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Pengiriman Ke Makloon';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="trn-kirim-makloon-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'status',
                'value' => function($data){
                    /* @var $data TrnKirimMakloon*/
                    return TrnKirimMakloon::statusOptions()[$data->status];
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filterWidgetOptions' => [
                    'data' => TrnKirimMakloon::statusOptions(),
                    'options' => ['placeholder' => '...'],
                    'pluginOptions'=>[
                        'allowClear' => true,
                    ]
