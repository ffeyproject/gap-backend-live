        ...
        <table width="100%">
            <tr>
                <td width="50%" style="text-align: left;">
                    <span style="margin-right: 15px;">NAMA BUYER :</span> <?=$model->nama_buyer?>
                </td>
        ...
        <table width="100%" border="1">
            ...
            <?php
                ...
                foreach ($dataProviderKirimBuyer->models as $kirimBuyerModel) {
                    foreach ($kirimBuyerModel->trnKirimBuyerItems as $pssk) {
                        ...
                        $groupedByNoBal[$no_bal][$no_wo]['colors'][$color][] = $qty;
            ...
            <?php foreach ($groupedByNoBal as $no_bal => $woGroup):?>
                ...
                <?php foreach ($woGroup as $no_wo => $colorGroup): ?>
                    ...
                    <td rowspan="<?= $woRowspan ?>" style="text-align: center;"><?= $colorGroup['design'] ?></td>
                    <?php foreach ($colorGroup['colors'] as $c => $qtys): ?>
                        <?php if (!$isFirstColorRow): ?>
                            <tr>
                        <?php endif; ?>
                            <td style="text-align: center;"><?= $c ?></td>
                            <td style="text-align: center;"><?= count($qtys) ?> PCS</td>
                            <td style="text-align: center;"><?= array_sum($qtys).' '.MstGreigeGroup::unitOptions()[$kirimBuyerModel->unit] ?></td>
                            <td>
                                        ...
                                        <?php
                                            ...
                                            for ($row = 0; $row < $totalRows; $row++) {
                                                ...
                                                for ($col = 0; $col < $itemsPerRow; $col++) {
                                                    ...
                                                    if ($index < $count) {
                                                        echo '<td style="text-align: center; width: 50px;">' . $qtys[$index] .'</td>';
                                                    } else {
