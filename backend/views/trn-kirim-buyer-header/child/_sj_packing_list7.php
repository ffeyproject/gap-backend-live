...
use common\models\ar\{ TrnKirimBuyer, MstGreigeGroup, TrnStockGreige };
                ...
                <?php foreach ($woGroup as $no_wo => $colorGroup): ?>
                    ...
                    <?php foreach ($colorGroup['colors'] as $c => $qtys): ?>
                        ...
                        <?php endif; ?>
                            ...
                            <?php 
                                $gradeCount = []; $recount_qtys = 0; $recount_subtotal = 0; $gradeTotalQty = [];
                                foreach ($qtys as $q) {
                                    $gradena = $q['grade'];
                                ...
                                $output_total = implode('<br> ', array_map(function($gradenih, $qtytotalcount) {
                                    return "- $gradenih = $qtytotalcount YARD";
