...
<div class="trn-kirim-buyer-header-form">
    ...
    <div class="box">
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-6"><?= $form->field($model, 'nama_buyer')->textInput(['maxlength' => true]) ?></div>

                <div class="col-md-6"><?= $form->field($model, 'alamat_buyer')->textInput(['maxlength' => true]) ?></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4"><?= $form->field($model, 'kepala_gudang')->textInput(['maxlength' => true]) ?></div>
            </div>

            <div class="row">
                <div class="col-md-6"><?= $form->field($model, 'plat_nomor')->textInput(['maxlength' => true]) ?></div>

                <div class="col-md-6">
                    <?= $form->field($model, 'is_export')->checkbox() ?>

                    <?= $form->field($model, 'is_resmi')->checkbox() ?>
                </div>
            </div>
