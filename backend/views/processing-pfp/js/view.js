    ...
    buttons: {
      submit: {
        ...
        action: function () {
          ...
          if (!ctn) {
            this.$content
              .find(".kartu-proses-textarea-hint")
              .html("Harap masukan " + label + "!!");
            return false;
          }
    ...
    buttons: {
      submit: {
        ...
        action: function () {
          ...
          if (!ctnWo) {
            this.$content
              .find(".input-no-wo-hint")
              .html("Harap masukan No. WO !!");
            return false;
          } else {
          ...
          if (!ctnColor) {
            this.$content
              .find(".input-color-hint")
              .html("Harap masukan color !!");
            return false;
          } else {
    ...
    buttons: {
      submit: {
        ...
        action: function () {
          ...
          if (!ctn) {
            this.$content
              .find(".input-motif-hint")
              .html("Harap masukan nama motif !!");
            return false;
          } else {
