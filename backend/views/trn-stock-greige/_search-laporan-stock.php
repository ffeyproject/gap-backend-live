    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-1"><?php echo $form->field($model, 'lot_lusi') ?></div>

                <div class="col-md-1"><?php echo $form->field($model, 'lot_pakan') ?></div>
                ...
                <div class="col-md-2">
                    <?= $form->field($model, 'asal_greige')->widget(\kartik\widgets\Select2::class, [
