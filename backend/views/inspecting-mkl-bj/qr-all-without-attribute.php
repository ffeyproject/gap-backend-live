    ...
    ?>
      <tr style="width: 100%;">
        <td style="width: 50%; height: 100%; padding: 1rem 0.5rem 1rem 1rem; text-align: center;" id="<?= mt_rand() ?>">
          <img class="img-fluid" style="height: 150px; width: 150px; margin: 0px;" src="<?='qrcode/'.$m['qr_code'].'.png'?>" alt="" id="<?= mt_rand() ?>">
        </td>
        <td style="width: 50%; height: 100%; padding: 1rem 1rem 1rem 0.5rem;" id="<?= mt_rand() ?>">
          <p style="font-family: Calibri; font-size: 3px; color: #fff;" id="<?= mt_rand() ?>"><b><?= "REGISTRASI K3L" ?></b><span style="color: #fff; font-family: Calibri; font-size: 6px;">Lorem ipsum dolor sit amet consectetur adipisicin. </span></p>
