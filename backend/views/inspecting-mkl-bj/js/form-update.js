...
$("#InspectingItemTable tbody").on("click", "button.editItemData", function () {
  ...
  $.confirm({
    ...
    content:
      ...
      '<option value="7">Grade A+</option><option value="8">Grade A*</option><option value="3">Grade C</option><option value="4">Piece Kecil</option><option value="5">Sample</option><option value="1">Grade A</option><option value="2">Grade B</option><option value="10">Grade D</option><option value="9">Grade Putih</option>' +
      "</select></div>" +
...
$("#InspectingFormItem").on("beforeSubmit", function () {
    ...
    let data = {
      ...
      defect: $("#inspectingmklbjitems-defect").val() ? $("#inspectingmklbjitems-defect").val().join(',') : '',
      lot_no: $("#inspectingmklbjitems-lot_no").val(),
      qty: $("#inspectingmklbjitems-qty").val(),
      join_piece: $("#inspectingmklbjitems-join_piece").val(),
      note: $("#inspectingmklbjitems-note").val(),
      qr_code: null
    };
