...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">SURAT JALAN EXPORT</h3>
        <div class="box-tools pull-right">
            <?=Html::button('<i class="fa fa-print" aria-hidden="true"></i>', ['class'=>'btn btn-default btn-xs', 'onclick'=>'printDiv("SjExport")'])?>
        </div>
    </div>
    <div class="box-body" id="SjExport">
        <table width="100%">
            <tr>
                <td width="40%">
        ...
        <table width="100%" border="1">
            ...
            <?php $i = 1; foreach ($dataProviderKirimBuyer->models as $kirimBuyerModel):?>
                ...
                <tr>
                    ...
                    <td><?=MstGreigeGroup::jenisKainOptions()[$kirimBuyerModel->scGreige->greigeGroup->jenis_kain]?> <?=$kirimBuyerModel->scGreige->greigeGroup->nama_kain?> <?=$kirimBuyerModel->nama_kain_alias?></td>
                    <td>
                        <?php
