...
/* @var $model InspectingDyeingReject */
...
<table style="width: 100%;" class="bordered">
    ...
    <tr>
        ...
        <td>
            <?php
            $totalPanjang = 0;
            foreach ($model->kartuProses->trnKartuProsesDyeingItems as $trnKartuProsesDyeingItems) {
                $stockGreige = $trnKartuProsesDyeingItems->stock->toArray();
