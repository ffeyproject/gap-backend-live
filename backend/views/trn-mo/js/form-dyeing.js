...
$moForm.on('afterInit', function (e) {
    ...
    $("#CheckBtMoReWo").click(function (e) {
        ...
        if (!noWo) {
            $moForm.yiiActiveForm('updateAttribute', 'trnmodyeingform-re_wo', ["Nomor WO tidak boleh kosong."]);
        }else {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#trnmodyeingform-selvedge_continues").val(data["selvedge_continues"]);
                    $("#trnmodyeingform-selvedge_stamping").val(data["selvedge_stamping"]);
