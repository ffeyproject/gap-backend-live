...
<div class="trn-beli-kain-jadi-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            if($model->isNewRecord){
                                $ajaxUrl = Url::to(['ajax/lookup-wo-beli-jadi']);
                                ...
                                echo $form->field($model, 'wo_id')->widget(Select2::class, [
                                    ...
                                    'pluginEvents' => [
                                        ...
                                        'select2:unselect' => 'function(e){$("#trnbelikainjadi-wo_color_id").val(null).trigger("change"); $("#trnbelikainjadi-wo_color_id").empty();}'
                                    ]
