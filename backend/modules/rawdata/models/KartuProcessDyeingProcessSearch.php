...
use backend\modules\rawdata\models\KartuProcessDyeingProcess;

/**
 * KartuProcessDyeingProcessSearch represents the model behind the search form of `backend\modules\rawdata\models\KartuProcessDyeingProcess`.
 */
