...
/* @var $model backend\modules\rawdata\models\TrnStockGreigeSearch */
...
<div class="trn-stock-greige-search">
    ...
    <?php // echo $form->field($model, 'jenis_gudang') ?>
    ...
    <?php // echo $form->field($model, 'nomor_wo') ?>

    <?php // echo $form->field($model, 'keputusan_qc') ?>
