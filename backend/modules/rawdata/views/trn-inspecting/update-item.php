...
/* @var $model common\models\ar\InspectingItem */
...
?>
<div class="inspecting-item-update">

    <h1><?= Html::encode($this->title) ?></h1>

    <div class="inspecting-item-form box box-primary">
        <div class="box-body">
            <?php $form = ActiveForm::begin(); ?>

            <?= $form->field($model, 'grade')->dropDownList(InspectingItem::gradeOptions()) ?>
