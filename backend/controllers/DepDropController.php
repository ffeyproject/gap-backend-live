                ...
                switch ($jenisProses){
                    case 'dyeing':
                        $query = TrnKartuProsesDyeing::find()
                            ...
                            ->andWhere(['status'=>[TrnKartuProsesDyeing::STATUS_APPROVED, TrnKartuProsesDyeing::STATUS_INSPECTED, TrnKartuProsesDyeing::STATUS_MAKE_UP_PACKING, TrnKartuProsesDyeing::STATUS_TERIMA_GUDANG_JADI, TrnKartuProsesDyeing::STATUS_PERIKSA_PENGIRIMAN]])
                            //->limit(20)
                            ->asArray()
                        ;
                        $out = $query->all();
